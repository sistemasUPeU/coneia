				...
				<div class="container" style="width: 95%;">
					<div class="section">
						...
						<div class="container" style="width: 90%;">
							...
							<br>
							<div class="row">
								<div class="container" id="ttt" style="width: 50%">

									<a class="waves-effect waves-light btn left indigo"
										style="margin-right: 10%;" id="buscar" onclick="buscar()"><i
										class="medium material-icons right"">search</i>Buscar</a> <a
										class="waves-effect waves-light btn red darken-4 right"
										id="clean"><i
										class="medium material-icons red darken-4 right">delete_sweep</i>Limpiar</a>
